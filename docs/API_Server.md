...
This endpoint is used to subscribe to raw accelerometer data produced by
`TEST_RESONANCES OUTPUT=raw_data`. Klipper streams this data while the
resonance test is running and does not retain raw samples after the test.

A request may look like:
`{"id": 123, "method":"resonance_tester/subscribe_raw_data",
"params": {"response_template": {}}}`
and might return:
`{"id": 123,"result":{"header":["time","x_acceleration","y_acceleration",
"z_acceleration"]}}`
and might later produce asynchronous messages such as:
`{"params":{"run_id":"20260101_120000-000001","axis":"x",
"point":[20.0,20.0,20.0],"chip_name":"adxl345","overflows":0,
"data":[[3292.432935,-535.44309,-1529.8374,9561.4],
[3292.433256,-382.45935,-1606.32927,9561.48375]]}}`

### resonance_tester/list_results

This endpoint lists short-lived processed resonance results generated by
`TEST_RESONANCES OUTPUT=resonances` and `SHAPER_CALIBRATE`. These results are
stored in Klipper memory and may be cleared by restart, by
`resonance_tester/clear_results`, or by older result eviction.

A request may look like:
`{"id": 123, "method":"resonance_tester/list_results"}`
and might return:
`{"id":123,"result":{"results":[{"id":"000001",
"run_id":"20260101_120000-000001","type":"resonances",
"name":"resonances_x_20260101_120000",
"filename":"resonances_x_20260101_120000.csv","axis":"x",
"point":null,"content_type":"text/csv","created":1767286800.0}]}}`

### resonance_tester/get_result

This endpoint returns one processed resonance result, including CSV content.

A request may look like:
`{"id": 123, "method":"resonance_tester/get_result",
"params":{"id":"000001"}}`
and might return:
`{"id":123,"result":{"id":"000001","run_id":"20260101_120000-000001",
"type":"resonances","name":"resonances_x_20260101_120000",
"filename":"resonances_x_20260101_120000.csv","axis":"x","point":null,
"content_type":"text/csv","created":1767286800.0,
"data":"freq,psd_x,psd_y,psd_z,psd_xyz\n..."}}`

### resonance_tester/clear_results

This endpoint clears processed resonance results. If an `id` parameter is
provided then only that result is cleared. Otherwise all stored resonance
results are cleared.

A request may look like:
`{"id": 123, "method":"resonance_tester/clear_results",
"params":{"id":"000001"}}`
